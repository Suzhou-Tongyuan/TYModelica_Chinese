  ...
  package Examples 
    ...
    equation
      ...
      annotation(
        ...
        grid = {2, 2}), graphics = {Rectangle(origin = {-65.5, 28}, 
        lineColor = {255, 0, 0}, 
        extent = {{-33.5, 20}, {33.5, -20}}), Text(origin = {-64.5, 55}, 
        lineColor = {255, 0, 0}, 
        extent = {{-33.5, 4}, {33.5, -4}}, 
        textString = "参考速度生成", 
        textColor = {255, 0, 0}), Text(origin = {-78, -50}, 
        lineColor = {255, 0, 0}, 
        extent = {{-20, 4}, {20, -4}}, 
        textString = "PI控制器", 
        textColor = {255, 0, 0}), Line(origin = {0, 0}, 
        points = {{-76, -44}, {-57, -23}}, 
        color = {255, 0, 0}, 
        arrow = {Arrow.None, Arrow.Filled}), Rectangle(origin = {37, -22}, 
        lineColor = {255, 0, 0}, 
        extent = {{-62, 28}, {62, -28}}), Text(origin = {37.5, 13}, 
        lineColor = {255, 0, 0}, 
        extent = {{-33.5, 4}, {33.5, -4}}, 
        textString = "被控对象(简单传动系统)", 
        textColor = {255, 0, 0})}), 
...
这个例子演示了如何使用Nonlinear.SlewRateLimiter(斜率限制器)模块来限制位置步进的速度和加速度：
</p>
<ul><li>
Sources.Step模块<code>positionStep</code>定义一个不符合物理规律的位置步进。</li>
<li>
第一个SlewRateLimiter模块<code>limit_v</code>限制速度。</li>
<li>
第一个Der(导数)模块<code>v</code>在平滑后的位置信号中计算速度。</li>
<li>
第二个SlewRateLimiter模块<code>limit_a</code>用于限制平滑后速度信号的加速度。</li>
<li>
第二个Der(导数)模块<code>a</code>用于从平滑后的速度信号中计算加速度。</li>
<li>
Integrator(积分)模块<code>positionSmoothed</code>从平滑后的速度信号计算平滑后的位置信号。</li>
</ul><p>
一个具备速度限制和加速度限制(即力矩限制)功能的位置控制驱动系统，能够跟踪平滑后的参考位置。
</p>
</html>"          ));
    end SlewRateLimiter;
