...
model MultiDelta 
  ...
  parameter Integer kPolygon=1 "多边形的替代方式";
  final parameter Integer mSystems=numberOfSymmetricBaseSystems(m) "基系统的数量";
  final parameter Integer mBasic=integer(m/mSystems) "基系统的相数";
...
equation
  when initial() then
    if (mBasic<=2 or kPolygon<1 or kPolygon>integer(mBasic - 1)/2) then
      print("MultiDelta: 将错误的 kPolygon = "+String(kPolygon)+" 替换为 kPolygon = 1");
    end if;
  end when;
...
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.UsersGuide.Polyphase\">多相指南</a>）。
</p>
<h4>另请参见</h4>
<p>
<a href=\"modelica://Modelica.Electrical.QuasiStatic.Polyphase.Basic.Star\">星形</a>,
<a href=\"modelica://Modelica.Electrical.QuasiStatic.Polyphase.Basic.Delta\">Delta</a>,
<a href=\"modelica://Modelica.Electrical.QuasiStatic.Polyphase.Basic.MultiStar\">多星形</a>
</p>
</html>"));
end MultiDelta;