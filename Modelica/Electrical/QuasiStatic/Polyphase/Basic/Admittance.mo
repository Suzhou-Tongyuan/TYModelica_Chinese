...
<p>导纳模型表示每相的电阻和电容器或电感器的<strong>并联</strong>连接。<br>
<img src=\"modelica://Modelica/Resources/Images/Electrical/QuasiStatic/SinglePhase/Basic/GB_admittance.png\"></p>

<p>
线性导纳通过 <code><u>i</u> = <u>Y</u>*<u>v</u></code> 将电压 <code><u>v</u></code> 和电流 <code><u>i</u></code> 连接起来，在每个相中，使用 <code>m</code>
<a href=\"modelica://Modelica.Electrical.QuasiStatic.SinglePhase.Basic.Admittance\">单相导纳</a>。
电阻的组件被建模为温度相关，所以实部 <code>G_actual = real(<u>Y</u>)</code> 由实际工作温度和参考输入电导 <code>real(Y_ref)</code> 确定。
<a href=\"modelica://Modelica.Electrical.Polyphase.Interfaces.ConditionalHeatPort\">条件热端口</a> 被考虑。
反应性的组件
<code>B_actual = imag(<u>Y</u>)</code>
等于 <code>imag(Y_ref)</code> 如果 <code>frequencyDependent = false</code>。
通过 <code>frequencyDependent = true</code> 考虑频率依赖性，区分两种情况：
</p>

<dl>
<dt>(a) <code>imag(Y_ref) &gt; 0</code>: 电容情况</dt>
<dd>实际的电感 <code>B_actual</code> 与 <code>f/f_ref</code> 成正比</dd>
<dt>(b) <code>imag(Y_ref) &lt; 0</code>: 电感情况</dt>
<dd>实际的电感 <code>B_actual</code> 与 <code>f_ref/f</code> 成正比</dd>
</dl>
