...
model VoltageQuasiRMSSensor 
  ...
  Modelica.Blocks.Interfaces.RealOutput V 
    "连续准均方根电流的平均值" annotation (Placement(
        transformation(
        origin={0,-110}, 
        extent={{-10,-10},{10,10}}, 
        rotation=270)));
  ...
  QuasiStatic.Polyphase.Blocks.QuasiRMS quasiRMS(final m=m) annotation (
      Placement(transformation(
        ...
        rotation=270, 
        origin={0,-50})));
  SI.ComplexVoltage v[m] = plug_p.pin.v - plug_n.pin.v "复数电压";
  SI.ComplexCurrent i[m] = plug_p.pin.i "复数电流";
equation
  ...
  annotation (defaultComponentName="voltageRMSSensor", 
    ...
    Documentation(revisions="<html>
      ...
      info="<html>
<p>
该传感器通过对相电压矢量的均值 <code>v</code> 进行求和来确定多相电压系统的连续准均方根值。
</p>
<pre>
