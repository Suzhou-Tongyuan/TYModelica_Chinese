...
model ReactivePowerSensor "三相无功功率传感器"
  ...
  Modelica.Blocks.Interfaces.RealOutput reactivePower "无功功率" 
...
<p>
包含 3 个功率计（Modelica.Electrical.Analog.Sensors.PowerSensor），用于测量三相系统中的总无功功率。
</p>
<p>
更多信息，请参见 [<a href=\"modelica://Modelica.Electrical.Polyphase.UsersGuide.References\">M&uuml;hl2017</a>].
</p>
</html>"));
