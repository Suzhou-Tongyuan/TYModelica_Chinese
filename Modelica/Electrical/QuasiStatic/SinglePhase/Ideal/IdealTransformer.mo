...
model IdealTransformer "理想变压器"
  parameter Real n=1 "主副电压比";
  SI.ComplexVoltage v1=pin_p1.v - pin_n1.v "1侧电压降";
  SI.ComplexCurrent i1=pin_p1.i "1侧电流";
  SI.ComplexVoltage v2=pin_p2.v - pin_n2.v "2侧电压降";
  SI.ComplexCurrent i2=pin_p2.i "2侧电流";

  SI.Voltage abs_v1=Modelica.ComplexMath.abs(v1) "复电压v1的幅值";
  ...
  SI.Voltage abs_v2=Modelica.ComplexMath.abs(v2) "复电压v2的幅值";
