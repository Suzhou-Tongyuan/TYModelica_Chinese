...
model ParallelResonance "并联谐振电路"
  extends Modelica.Icons.Example;
  output SI.Voltage V_abs=complexToPolar.len "电压";
  output SI.Angle V_arg=complexToPolar.phi "电压相位";
...
<p>
电流源的频率通过斜坡变化。
绘制电压相量的长度和角度，即 complexToPolar.len 和 .phi，相对于时间或频率。
</p>
</html>"), 
