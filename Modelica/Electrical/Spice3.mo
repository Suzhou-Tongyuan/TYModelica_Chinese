...
.END
    ...
    equation
      ...
      parameter Modelica.Electrical.Spice3.Semiconductors.ModelcardDIODE DMOD "二级管的模型卡";
      parameter Modelica.Electrical.Spice3.Semiconductors.ModelcardBJT QMOD(BF=75, RB=100, CJE=1e-012, CJC=3e-012) "晶体管的模型卡";
...
<p>SPICE3库使用Modelica.Electrical.Analog接口。此Interfaces库中仅包含SPICE3库中使用的特殊部分模型。</p>
  ...
  package Types "Spice3类型定义(额外部分)"
    ...
    type Capacitance = SI.Capacitance(min=-Modelica.Constants.inf) "无界电容";
    ...
    type InverseElectricCurrent = Real (final quantity="InverseElectricCurrent", final unit="1/A") "电流的倒数";
