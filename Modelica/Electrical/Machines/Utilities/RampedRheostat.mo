...
model RampedRheostat "具有线性减小电阻的电阻器"
  ...
  parameter SI.Time tStart 
    "减小电阻的时间点";
  parameter SI.Time tRamp "线性斜坡的持续时间";
  ...
  annotation (defaultComponentName="rheostat", 
    Icon(graphics={
        ...
        Line(points={{20,0},{26,0}}, color={0,0,255})}), Documentation(info= 
         "<html>
<p>用于带滑环转子的感应电机启动的电阻器：</p>
<p>外部转子电阻<code>RStart</code>会线性减小到零，从时间<code>tStart</code>开始，持续时间为<code>tRamp</code>。</p>
</html>"));
end RampedRheostat;