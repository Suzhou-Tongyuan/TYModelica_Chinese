...
model SwitchYD "Y-D开关"
  ...
  Modelica.Electrical.Polyphase.Interfaces.PositivePlug plug_sp(final m=m) 
    "接入正相插头" annotation (Placement(transformation(extent={
            {50,-90},{70,-110}})));
  Modelica.Electrical.Polyphase.Interfaces.NegativePlug plug_sn(final m=m) 
    "接入负相插头" annotation (Placement(transformation(extent={
            {-70,-90},{-50,-110}})));
...
简单的星-三角开关。<br>
如果<em>control</em>为false，则plug_sp和plug_sn是星形连接的，并且plug_sp连接到供电插头。<br>
如果<em>control</em>为true，则plug_sp和plug_sn是三角形连接的，并且它们连接到供电插头。<br>
请注意，在打开星形连接和关闭三角形连接，或者打开三角形连接和关闭星形连接之间存在延迟。
</html>"));
end SwitchYD;