...
model DCSE_SinglePhase 
  ...
  Modelica.Electrical.Analog.Sources.SineVoltage constantVoltage(V=sqrt(2) 
        *Va, f=50) annotation (Placement(transformation(origin={-14,40}, 
extent={{10,10},{-10,-10}})));
...
points={{-20,-46},{-30,-46},{-30,40},{-24,40}}, 
color={0,0,255}));
  connect(dcse.flange, loadInertia.flange_a) annotation (Line(
      points={{0,-40},{40,-40}}));
  connect(constantVoltage.p, variableResistor.p) annotation (Line(origin={0,0}, 
points={{-4,40},{0,40},{0,20}}, 
color={0,0,255}));
  connect(variableResistor.n, dcse.pin_ap) annotation (Line(origin={0,0}, 
points={{0,0},{0,-30},{-4,-30}}, 
color={0,0,255}));
