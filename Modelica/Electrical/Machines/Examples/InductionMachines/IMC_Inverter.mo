...
model IMC_Inverter 
  ...
  parameter SI.Time tStep=1.2 "载荷扭矩步进时间";
...
使用VfController和三相SignalVoltage建模了理想的频率逆变器。 通过斜坡提高频率，导致鼠笼型感应电机启动，并加速惯性。<br>在时间tStep施加载荷步进。
</p>
<p>
该示例的仿真时长为1.5秒，用户可以在特定窗口通过勾选绘制以下结果变量的图像：(随时间变化)：
</p>
<li>
currentQuasiRMSSensor.I: 定子电流 RMS</li>
<li>
