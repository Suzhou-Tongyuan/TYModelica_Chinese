...
model IMC_DOL 
  ...
  Modelica.Blocks.Sources.BooleanStep booleanStep[m](each startTime= 
        tStart1) annotation (Placement(transformation(origin={-70,30}, 
extent={{-10,-10},{10,10}})));
...
equation
  ...
  connect(booleanStep.y, idealCloser.control) annotation (Line(origin={0,0}, 
points={{-59,30},{-12,30}}, 
color={255,0,255}));
...
在起始时间tStart时，鼠笼型感应电机的开始供电； 电机从静止开始，对抗负载扭矩，加速惯性，负载扭矩与速度成二次相关， 最终达到额定速度。
</p>
<p>
示例仿真时间为1.5秒，用户可以在特定界面通过勾选绘制(随时间变化)的以下变量图像：
</p>
<li>
