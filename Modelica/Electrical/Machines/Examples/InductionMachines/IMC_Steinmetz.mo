...
model IMC_Steinmetz 
  ...
  parameter SI.Time tStart1=0.1 "启动时间";
  ...
  parameter SI.AngularVelocity wSwitch(displayUnit="rev/min")= 
    ...
    "关闭起动电容的速度";
  parameter SI.Torque TLoad=2/3*161.4 "额定负载转矩";
...
equation
  ...
  annotation (experiment(StopTime=1, Interval=1E-4, Tolerance=1e-06), Documentation(info="<html><p>
在启动时间 tStart 时，单相电压被供应给鼠笼型感应电机； 电机从静止开始，克服负载扭矩的二次速度依赖的惯性加速，最终达到额定速度。
</p>
<p>
使用默认的电机参数。
</p>
