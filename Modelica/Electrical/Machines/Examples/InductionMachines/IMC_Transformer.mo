...
model IMC_Transformer
  ...
  Modelica.Electrical.Analog.Basic.Ground ground2 annotation (Placement(transformation(origin={-50,25},
extent={{-10,-10},{10,10}},
rotation=270)));
...
equation
  ...
  connect(transformer.starpoint2, ground2.p) annotation (Line(origin={0,0},
points={{-30,25},{-40,25}},
color={0,0,255}));
