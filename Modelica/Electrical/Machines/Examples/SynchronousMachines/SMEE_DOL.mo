...
model SMEE_DOL 
  ...
  parameter SI.Voltage Ve=smeeData.Re*smeeData.IeOpenCircuit "励磁电流";
...
<p>电励磁同步发电机直接利用阻尼笼(和短接励磁绕组)在0秒时在线启动。</p>
<p>在t=0.5秒时，励磁电压提高以实现无负载励磁电流。注意，定子的无功功率变为零。</p>
<p>在t=2秒时，施加驱动扭矩阶跃到轴(即激活涡轮)。注意，定子的有功和无功功率发生变化。为了以更高的扭矩驱动，即产生更多的电功率，需要调整励磁。</p>

<p>该示例的仿真时长为3秒，用户可以在特定界面绘制以下变量的图像：</p>
...
<h5>注意</h5>
<p>在时间=0时关闭主开关以避免由<code>rotorDisplacementAngle</code>计算的非物理噪声。此噪声是由于开关的高电阻与机器的交互引起的，请参见
