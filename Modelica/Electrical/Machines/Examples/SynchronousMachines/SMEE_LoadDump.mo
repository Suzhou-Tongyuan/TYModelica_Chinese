...
model SMEE_LoadDump 
  ...
  parameter Real k=2*Ve0/smeeData.VsNominal "电压控制器增益";
...
<p>
使用速度坡道启动电励磁同步发电机，然后以恒定速度驱动。
电压受控，设定点取决于速度。启动后，负载发电机，负载被拒绝。</p>

<p>模型的仿真时长为10秒，用户可以在特定界面通过勾选绘制以下变量的图像：</p>
