...
block BusTranscription "总线信号转录"
  extends Modelica.Blocks.Icons.Block;
  parameter Integer Ns(final min = 1) = 1 "串联电池数量";
  parameter Integer Np(final min = 1) = 1 "并联电池数量";
  Modelica.Electrical.Batteries.Interfaces.StackBus stackBus(Np=Np, Ns=Ns) 
    "堆叠总线" annotation (Placement(transformation(
        extent={{-20,-20},{20,20}}, 
        rotation=90, 
        origin={-100,0})));
  Modelica.Electrical.Batteries.Interfaces.StackBusArrays stackBusArrays(Np=Np, 
      Ns=Ns) "带信号数组的堆叠总线" annotation (Placement(
        transformation(
        extent={{-20,-20},{20,20}}, 
        rotation=270, 
        origin={100,0})));
...
<p>
将信息从<a href=\"modelica://Modelica.Electrical.Batteries.Interfaces.StackBus\">stackBus</a>传输到<a href=\"modelica://Modelica.Electrical.Batteries.Interfaces.StackBusArrays\">stackBusArrays</a>。
</p>
</html>"));
