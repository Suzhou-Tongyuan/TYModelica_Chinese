...
partial model BaseCellWithSensors "带传感器的部分电池"
  ...
  parameter Real SOC0=0.1 "初始SOC";
  parameter Real SOCtolerance=1e-9 "用于检测电池耗尽或过充的SOC容差" 
    annotation(Dialog(tab="高级"));
  extends Modelica.Electrical.Analog.Interfaces.TwoPin;
  output SI.Current i = p.i "电池电流";
  output SI.Power power = v*i "电池功率";
  output Real SOC = limIntegrator.y "电池充电状态";
  ...
  Modelica.Thermal.HeatTransfer.Sensors.HeatFlowSensor heatFlowSensor 
    annotation (Placement(transformation(
        ...
        rotation=270, 
        origin={0,-60})));
  Modelica.Electrical.Batteries.Interfaces.CellBus cellBus "电池总线" 
...
<p>
这是带有测量的单个<a href=\"modelica://Modelica.Electrical.Batteries.BatteryStacks.CellStack\">cell[Np=1, Ns=1]</a>。
</p>
</html>"));
