...
partial model BaseStackWithSensors "带传感器的部分堆栈"
  ...
  parameter Boolean useAllParallelConnections=true "= true，如果所有并联连接都被使用";
  parameter Real SOC0[stackData.Ns, stackData.Np]=fill(0.1, stackData.Ns, stackData.Np) "初始SOC";
  parameter Real SOCtolerance=1e-9 "用于检测电池耗尽或过充的SOC容差" 
    annotation(Dialog(tab="高级"));
  extends Modelica.Electrical.Analog.Interfaces.TwoPin;
  output SI.Current i = p.i "电池堆栈电流";
  output SI.Power power = v*i "电池堆栈功率";
  output Real SOC = socTotal.y "整体充电状态";
  parameter Boolean useHeatPort = false "=true，如果使用HeatPort" 
...
<p>
这是一个<code>Ns</code>x<code>Np</code><a href=\"modelica://Modelica.Electrical.Batteries.BatteryStacksWithSensors.Cell\">cell[Np=1, Ns=1]</a>堆栈，带有测量，排列成矩阵。
</p>
</html>"));
