...
<p>
包含m个余弦电流源(Modelica.Electrical.Analog.Sources.CosineCurrent)具有由<a href=\"modelica://Modelica.Electrical.Polyphase.Functions.symmetricOrientation\">symmetricOrientation</a>确定的默认相位移。
</p>
</html>"));
end CosineCurrent;