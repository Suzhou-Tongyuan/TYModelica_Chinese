...
model HeatingPNP_NORGate "考虑热特性的PNP构成的异或门电路"
  ...
  Modelica.Electrical.Analog.Sources.TrapezoidVoltage V1(
    ...
    period = 50,
    nperiod = 10,
    V = -6) annotation(Placement(transformation(origin={-96,18},
extent={{-10,-10},{10,10}},
rotation=270)));
  ...
  Modelica.Electrical.Analog.Basic.Resistor R1(R = 1800) 
    annotation(Placement(transformation(origin={-80,62},
extent={{-10,-10},{10,10}})));
...
grid={2,2}),graphics = {Text(origin={-53,96},
lineColor={0,0,255},
extent={{-47,14},{47,-14}},
textString="加热型 \"PNP NOR\" 电路",
textColor={0,0,255})}),
