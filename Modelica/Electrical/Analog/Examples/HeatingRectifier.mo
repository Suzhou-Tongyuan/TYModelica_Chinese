...
model HeatingRectifier "考虑热特性的整流器"
  ...
  annotation (Placement(transformation(origin={-10,-50}, 
extent={{-10,-10},{10,10}}, 
rotation=180)));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor ThermalConductor1(G=10) 
  annotation (Placement(transformation(origin={-10,-10}, 
extent={{-10,-10},{10,10}}, 
rotation=270)));
...
grid={2,2}),graphics = {Text(origin={-47,88}, 
lineColor={0,0,255}, 
extent={{-47,14},{47,-14}}, 
textString="考虑热特性的整流器", 
textColor={0,0,255})}), 
