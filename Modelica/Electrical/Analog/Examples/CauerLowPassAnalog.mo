...
grid={2,2}),graphics = {Rectangle(origin={-60,30}, 
lineColor={0,0,255}, 
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,2},{2,-2}}), Rectangle(origin={0,30}, 
lineColor={0,0,255}, 
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,-2},{2,2}}), Rectangle(origin={60,30}, 
lineColor={0,0,255}, 
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,2},{2,-2}}), Rectangle(origin={60,-50}, 
lineColor={0,0,255}, 
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,2},{2,-2}}), Rectangle(origin={0,-50}, 
lineColor={0,0,255}, 
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,2},{2,-2}}), Rectangle(origin={-60,-50}, 
...
fillColor={85,85,255}, 
fillPattern=FillPattern.Solid, 
extent={{-2,2},{2,-2}}), Text(origin={0,90}, 
lineColor={0,0,255}, 
extent={{-120,10},{120,-10}}, 
textString="Cauer低通滤波器", 
textColor={0,0,255})}), 
