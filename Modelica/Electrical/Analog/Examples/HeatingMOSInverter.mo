...
model HeatingMOSInverter "考虑热特性的MOS逆变器"
...
lineColor={0,0,255}, 
extent={{-47,14},{47,-14}}, 
textString="考虑热特性的MOS逆变器", 
textColor={0,0,255})}), Documentation(info="<html>
<p>加热型MOS逆变器示例显示了当一个晶体管是导通时始终有热流的过程。</p>
<p>该示例的仿真时长为5秒。用户可在“仿真--仿真浏览器”中勾选相应的“仿真结果变量”查看示例Sin.p.v、Capacitor1.p.v、HeatCapacitor1.port.T、H_PMOS.heatPort.T、H_NMOS.heatPort.T、H_PMOS.heatPort.Q_flow和H_NMOS.heatPort.Q_flow等结果变量的图像。</p>
</html>", 
   revisions="<html>
