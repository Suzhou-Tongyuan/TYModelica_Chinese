...
equation
  ...
  connect(sineVoltage.p, aD_Converter.p) annotation (Line(origin={0,0}, 
points={{-80,14},{-80,16},{-14,16}}, 
color={0,0,255}));
  connect(sineVoltage.n, aD_Converter.n) annotation (Line(origin={0,0}, 
points={{-80,-6},{-80,-10},{-14,-10}}, 
color={0,0,255}));
