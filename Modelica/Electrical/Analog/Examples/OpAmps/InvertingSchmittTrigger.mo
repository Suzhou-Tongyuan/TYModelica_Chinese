...
model InvertingSchmittTrigger "(反相)滞回触发器"
  ...
  Modelica.Electrical.Analog.Sources.TrapezoidVoltage vIn(
    ...
    V=2*Vin,
    offset=-Vin) annotation (Placement(transformation(origin={-80,-6},
extent={{-10,-10},{10,10}},
rotation=270)));
...
equation
  ...
  connect(vIn.p, opAmp.in_n) annotation (Line(origin={0,0},
points={{-80,4},{-80,6},{0,6}},
color={0,0,255}));
  connect(ground.p, vIn.n) annotation (Line(origin={0,-2},
points={{-10,-78},{-80,-78},{-80,-14}},
color={0,0,255}));
