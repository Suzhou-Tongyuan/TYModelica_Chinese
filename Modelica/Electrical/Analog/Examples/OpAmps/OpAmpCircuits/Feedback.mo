...
model Feedback "减法运算放大器电路"
  extends PartialOpAmp;
  SI.Voltage v1_2=p1_2.v - n1.v "端口1_2的压降 (= p1_2.v - n1.v)";
  SI.Current i1_2=p1_2.i "电流从端口1_2的正极流向负极";
  parameter Real k(final min=0)=1 "期望的放大倍数";
  parameter SI.Resistance R1=1000 "OpAmp的输入电阻";
  parameter SI.Resistance R3=R1/k "计算出的电阻以达到期望的放大倍数k";
...
<p>该示例为带反馈的反相减法器电路，该示例基于<a href=\"modelica://Modelica.Electrical.Analog.Ideal.IdealizedOpAmpLimited\">IdealizedOpAmpLimited</a>搭建。</p>
