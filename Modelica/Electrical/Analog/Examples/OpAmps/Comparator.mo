...
model Comparator "比较器"
  ...
  Modelica.Electrical.Analog.Sources.TrapezoidVoltage vIn(
    ...
    V=2*Vin,
    offset=-Vin) annotation (Placement(transformation(origin={-80,-8},
extent={{-10,-10},{10,10}},
rotation=270)));
  ...
  Modelica.Electrical.Analog.Sources.SupplyVoltage supplyVoltage(Vps=Vps, Vns=
       Vns) annotation (Placement(transformation(
        ...
        origin={-10,-50})));
equation
  connect(vIn.p, opAmp.in_p) annotation (Line(origin={0,0},
points={{-80,2},{-80,6},{0,6}},
color={0,0,255}));
  ...
  connect(ground.p, vIn.n) annotation (Line(origin={0,0},
points={{-10,-80},{-10,-62},{-80,-62},{-80,-18}},
color={0,0,255}));
