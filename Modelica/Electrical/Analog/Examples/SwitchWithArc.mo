...
model SwitchWithArc "比较产生与不产生电弧效应的开关模型之间的差异"
...
grid={2,2}),graphics = {Text(origin={-5,80},
lineColor={0,0,255},
extent={{-91,8},{91,-8}},
textString="比较电感1和电感2的电压和电流",
textColor={0,0,255})}),
    experiment(
    StopTime = 2,
    Interval = 0.00025,
...
<p>这个示例比较了产生与不产生电弧效应的开关模型之间的行为差异。</p>
<ul>
<li>该示例的仿真时间为2秒。</li>
<li>用户可在“仿真--仿真浏览器”中勾选相应的“仿真结果变量”查看以下变量的图像:<code>switch1.i</code>和<code>switch2.i</code></li>
</ul>
<p>通过比较两种开关模型，可以发现使用简单的电弧模型能够避免开关在闭合时突然变化(指断开行为)。</p>
</html>",
    revisions = "<html>
<ul>
<li><em>2009/5   </em>
