...
model M_OLine "复合有损传输线"
  parameter SI.Length length(final min = Modelica.Constants.small) = 0.1 "线路长度";
...
public
  ...
  model segment "多线段模型"
    ...
    parameter Integer dim_vector_lgc = div(lines * (lines + 1), 2) "l,g,c向量的长度";
    Modelica.Electrical.Analog.Interfaces.PositivePin p[lines] "正极引脚" 
      annotation(Placement(transformation(extent = {{-110, -10}, {-90, 10}}), iconTransformation(extent = {{-110, -10}, {-90, 10}})));
    Modelica.Electrical.Analog.Interfaces.NegativePin n[lines] "负极引脚" 
