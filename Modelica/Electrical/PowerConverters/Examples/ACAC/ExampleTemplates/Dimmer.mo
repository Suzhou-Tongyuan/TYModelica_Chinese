...
partial model Dimmer "调光器包括控制"
  extends Icons.ExampleTemplate;
  import Modelica.Constants.pi;
  parameter SI.Frequency f=50 "源频率";
  parameter SI.Voltage Vrms=110 "RMS源电压";
  parameter SI.ApparentPower S=1000 "负载视在功率";
  parameter Real powerFactor(final min=0, final max=1)=0.87 "负载功率因数";
