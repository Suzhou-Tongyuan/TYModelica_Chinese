...
model Polyphase2Level "多相直流到交流转换器"
...
<p>
这是一个多相两级逆变器。对于任何相 <code>k</code>，布尔信号 <code>fire_p[k]</code> 和 <code>fire_n[k]</code> 不能同时为 <code>true</code>，以避免直流母线短路。该逆变器分别由 <code>2*m</code> 个晶体管和两个反并联自由轮二极管组成，其中 <code>m</code> 是相数。
</p>
</html>"));
end Polyphase2Level;