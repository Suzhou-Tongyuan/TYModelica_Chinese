...
<p>
交错 PWM 将输入空间相量 <u>u</u> 转换为三相电压，并将其与参考信号进行比较。
只要相电压大于相应的参考信号，相应的火信号就为真。
...
<ul>
<li>Sawtooth1: 锯齿信号，所有三相相同相位</li>
<li>Sawtooth3: 锯齿信号，三相之间的相移 = 周期/3</li>
<li>Triangle1: 三角形信号，所有三相相同相位</li>
<li>Triangle3: 三角形信号，三相之间的相移 = 周期/3</li>
</ul>
</html>"));
end IntersectivePWM;