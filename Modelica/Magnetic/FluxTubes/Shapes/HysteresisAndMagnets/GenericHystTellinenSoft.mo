...
model GenericHystTellinenSoft
  ...
  // 对话组滞后
  parameter SI.MagneticFluxDensity Js = 1.8 "饱和偏振" annotation (Dialog(group="磁滞", groupImage="modelica://Modelica/Resources/Images/Magnetic/FluxTubes/Shapes/HysteresisAndMagnets/GenericHystTellinenSoft/SoftMagneticHysteresis2.png"));
  parameter SI.MagneticFluxDensity Br=0.9 "余热" annotation (Dialog(group="磁滞"));
  parameter SI.MagneticFieldStrength Hc=120 "矫顽力" annotation (Dialog(group="磁滞"));
...
equation
  ...
  annotation (defaultComponentName="铁芯", Documentation(info="<html>
