...
<h5>版本3.2.2, 2014-12-05 (Johannes&nbsp;Ziske, Thomas&nbsp;B&ouml;drich)</h5>
...
<h5>版本3.2.2, 2014-01-15 (Christian&nbsp;Kral)</h5>
...
<h5>版本1.5, 2013-01-04 (Martin&nbsp;Otter, Thomas&nbsp;B&ouml;drich, Johannes&nbsp;Ziske)</h5>
<ul>
<li>添加了缺失的初始条件</li>
<li>固定初始参数值</li>
</ul>

<h5>版本1.4, 2011-08-01 (Thomas&nbsp;B&ouml;drich)</h5>
<ul>
<li>用 MagneticPotential 代替 MagneticPotentialDifference 声明的 MagneticPort</li>
</ul>

<h5>版本1.3, 2010-04-22 (Christian&nbsp;Kral)</h5>
<ul>
<li>为涡流模型添加了条件热端口</li>
</ul>

<h5>版本1.2, 2009-08-11 (Christian&nbsp;Kral, Anton&nbsp;Haumer, Thomas&nbsp;B&ouml;drich, Martin&nbsp;Otter)</h5>
<ul>
<li>更新和改进，以便纳入
    Modelica模型标准库</li>
</ul>

<h5>版本1.1, 2009-05-19 (Thomas&nbsp;B&ouml;drich)</h5>
<ul>
...
<h5>版本1,0, 2007-10-11 (Thomas&nbsp;B&ouml;drich)</h5>
<ul>
<li>发布模型库1.0版本</li>
</ul>
