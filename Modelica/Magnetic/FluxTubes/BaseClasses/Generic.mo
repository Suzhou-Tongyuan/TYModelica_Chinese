...
partial model Generic "部分Tellinen滞后模型"
  extends Interfaces.TwoPort;
  extends Modelica.Magnetic.FluxTubes.Icons.Reluctance;

  // 固定几何群(长方体)
  parameter SI.Length l=0.1 "通量方向上的长度" annotation (Dialog(group="固定几何", groupImage= 
          "modelica://Modelica/Resources/Images/Magnetic/FluxTubes/Interfaces/GenericParallelFlux.png"));

  parameter SI.Area A=1e-4 "横截面面积" annotation (Dialog(group="固定几何", groupImage= 
