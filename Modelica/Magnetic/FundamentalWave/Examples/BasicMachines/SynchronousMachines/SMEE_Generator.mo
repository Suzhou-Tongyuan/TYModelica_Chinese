...
model SMEE_Generator 
  ...
  parameter SI.AngularVelocity w= 
      Modelica.Units.Conversions.from_rpm(1499) "标称速度";
  parameter SI.Current Ie=19 "激励电流";
  parameter SI.Current Ie0=10 "初始激磁电流";
...
<p>
An
<a href=\"modelica://Modelica.Magnetic.FundamentalWave.BasicMachines.SynchronousMachines.SM_ElectricalExcited\">electrically excited synchronous generator</a> 与电网相连，并以恒定速度驱动.
由于转速略低于与主频率相对应的同步转速、
转子角度的增加非常缓慢。由此可以看出与转子角度有关的几个特性.
</p>

<p>
模拟 30 秒并绘制曲线（与 <code>RotorAngleM.rotorDisplacementAngle</code> 相对）。:
</p>

<ul>
<li><code>speedM|E.tauElectrical</code>: 机器扭矩</li>
<li><code>mechanicalPowerSensorM|E.P</code>: 机械动力</li>
</ul>
</html>"));
end SMEE_Generator;