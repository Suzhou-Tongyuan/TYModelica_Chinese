...
和相位<a href=\"modelica://Modelica.Electrical.Polyphase.Sources.SignalVoltage\">SignalVoltage</a>s。
频率被一个斜坡提高，导致
...
加速惯量。在<code>tStep</code>时刻，应用了一个加载步骤。比较了两种不同相数的等效电机，证明了它们的等效性能.
</p>
