...
<img src=\"modelica://Modelica/Resources/Images/Magnetic/FundamentalWave/m.png\">相位。若保持架采用等效定子绕组参数建模，则有效匝数，
<img src=\"modelica://Modelica/Resources/Images/Magnetic/FundamentalWave/effectiveTurns.png\">，必须选择相当于定子有效匝数的值.
</p>
