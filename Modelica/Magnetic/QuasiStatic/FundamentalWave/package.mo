...
package FundamentalWave "准静态基波电机"
  extends Modelica.Icons.Package;
  annotation (preferredView="info", Documentation(info="<html>
  <p><strong>有关各种机器型号的区分，请参见 <a href=\"modelica://Modelica.Electrical.Machines.UsersGuide.Discrimination\">discrimination</a></strong>.</p>
<p>
