...
model SMPM_CurrentSource 
  "测试示例:由电流源供电的permanentmagnetsynchronousmmachine"
  extends Modelica.Icons.Example;
  import Modelica.Constants.pi;
  parameter Integer m=3 "相数" annotation(Evaluate=true);
  parameter SI.Voltage VNominal=100 
    "每相标称均方根电压";
  parameter SI.Frequency fNominal=smpmData.fsNominal "标称频率";
...
<p>
本例比较了永磁同步电机的时间暂态模型和准静态模型。这些机器由电流源供电。所述电流分量沿磁场方向定向并变换到定子固定参考系中。这样，机器就能以恒定的扭矩运转。机器从静止状态开始加速.</p>
...
<ul>
<li><code>smpm|smpmQS.wMechanical</code>: 机速度</li>
