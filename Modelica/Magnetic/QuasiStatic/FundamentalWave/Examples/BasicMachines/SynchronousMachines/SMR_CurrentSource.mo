...
model SMR_CurrentSource 
  ...
  parameter SI.Voltage VNominal=100 
    "每相标称均方根电压";
  parameter SI.Frequency fNominal=smrData.fsNominal "标称频率";
  ...
  SI.Angle theta=rotorDisplacementAngle.rotorDisplacementAngle "转子位移角，瞬态";
  ...
  parameter
    ...
    smrData(useDamperCage=false) "同步机数据" 
...
<p>
这个例子比较了同步磁阻电机的时间暂态模型和准静态模型。
这些机器由电流源供电。电流元件指向磁场
定子定向并变换为定子固定参考系。这样，机器就能以恒定的扭矩运转。
机器从静止状态开始加速.</p>
