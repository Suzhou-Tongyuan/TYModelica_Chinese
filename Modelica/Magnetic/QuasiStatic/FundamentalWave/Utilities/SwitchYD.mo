...
model SwitchYD "Y-D 开关"
  ...
  Modelica.Electrical.QuasiStatic.Polyphase.Interfaces.PositivePlug plug_sp(final m=m) 
    "至正极定子插头" annotation (Placement(transformation(extent={
            {50,-90},{70,-110}})));
  Modelica.Electrical.QuasiStatic.Polyphase.Interfaces.NegativePlug plug_sn(final m=m) 
    "至定子负极插头" annotation (Placement(transformation(extent={
            {-70,-90},{-50,-110}})));
...
简单的星三角开关.<br>
如果<em>control</em>为false, plug_sp和plug_sn星形连接，plug_sp接电源插头。<br>
如果<em>control</em>为true，则plug_sp和plug_sn是增量连接，并且它们连接到电源插头上.
</html>"));
end SwitchYD;