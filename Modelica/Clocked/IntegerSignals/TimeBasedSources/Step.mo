...
<p>该模块类似于<a href=\"modelica://Modelica.Blocks.Sources.IntegerStep\">Modelica.Blocks.Sources.IntegerStep</a>，
但经调整后可在时钟分区中工作（通过对连续 <strong>time</strong> 变量进行内部采样）。
</p>
<p>
整数输出 y 是阶跃信号：
</p>
...
<h4>Example</h4>
<p>
见模型 <a href=\"modelica://Modelica.Clocked.Examples.Elementary.IntegerSignals.TimeBasedStep\">Modelica.Clocked.Examples.Elementary.IntgerSignals.TimeBasedStep</a>.
<br>
</p>
</html>"));
end Step;