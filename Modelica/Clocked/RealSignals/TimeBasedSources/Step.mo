...
block Step "生成实数类型的阶跃信号"
  ...
  parameter Real height = 1 "阶梯高度";
  parameter Real offset = 0 "输出信号的偏移 y";
...
<p>该模块类似于 <a href=\"modelica://Modelica.Blocks.Sources.Step\">Modelica.Blocks.Sources.Step</a> 中的模块，但
可在时钟分区中工作（通过对连续 <strong>time</strong> 变量进行内部采样）。
</p>
<p>
实数输出 y 是阶跃信号：
</p>
...
<h4>Example</h4>
<p>
见模型 <a href=\"modelica://Modelica.Clocked.Examples.Elementary.RealSignals.TimeBasedStep\">Modelica.Clocked.Examples.Elementary.RealSignals.TimeBasedStep</a>.
<br>
</p>
