...
grid={2,2}),graphics = {Text(origin={-16,34},
lineColor={255,0,0},
extent={{-25,3},{25,-3}},
textString="反馈控制",
textColor={255,0,0}), Text(origin={71,34},
lineColor={255,0,0},
extent={{-25,3},{25,-3}},
textString="被控对象",
textColor={255,0,0}), Rectangle(origin={-89,15},
lineColor={255,0,0},
extent={{-17,25},{17,-25}}), Text(origin={-89,34},
lineColor={255,0,0},
extent={{-24,3},{24,-3}},
textString="期望信号",
textColor={255,0,0}), Rectangle(origin={-18,0},
lineColor={255,0,0},
extent={{-32,40},{32,-40}}), Rectangle(origin={72,0},
lineColor={255,0,0},
extent={{-36,40},{36,-40}})}),
