...
model SuperSampled 
  "带有时钟级联控制器的硬盘，其中最快分区由时钟定义，较慢分区由超级采样定义"
 ...
 extends Modelica.Icons.Example;
  ...
  Modelica.Blocks.Sources.KinematicPTP2 kinematicPTP(
    ...
    qd_max={2}, 
    qdd_max={3}) 
    annotation (Placement(transformation(origin={-124,2}, 
extent={{-10,-10},{10,10}})));
...
extent={{-25,3},{25,-3}}, 
textString="被控对象", 
textColor={255,0,0}), Rectangle(origin={-125,6}, 
lineColor={255,0,0}, 
extent={{-15,34},{15,-34}}), Text(origin={-124,35}, 
lineColor={255,0,0}, 
...
<span style=\"color: rgb(51, 51, 51);\">级联控制驱动系统，采用离散时间控制器，其中为最快的控制回路定义了一个周期性时钟，而较慢控制回路的周期性时钟则通过在“super”块中定义的超采样因子隐式定义。</span>
</p>
</html>"), 
