...
model SubClocked
  "带有时钟级联控制器的驱动装置，其中时钟通过子采样定义，分区通过超采样定义"
...
textString="期望信号",
textColor={255,0,0}), Rectangle(origin={-59,-6},
lineColor={255,0,0},
extent={{-27,46},{27,-46}}), Rectangle(origin={12,-6},
lineColor={255,0,0},
extent={{-26,46},{26,-46}}), Rectangle(origin={96,-6},
lineColor={255,0,0},
extent={{-40,46},{40,-46}}), Text(origin={-58,35},
lineColor={255,0,0},
extent={{-25,3},{25,-3}},
textString="慢速控制器(外环)",
textColor={255,0,0})}),
    Documentation(info="<html><p>
<span style=\"color: rgb(51, 51, 51);\">级联控制驱动系统，采用离散时间控制器，其中定义了一个周期性时钟，第二个周期性时钟通过对第一个时钟的子采样得到，且两个时钟与相应的控制器分区相关联。块“super”的超采样因子通过时钟推导得出。</span>
</p>
</html>"),
