...
model MixingUnit 
  "混合装置演示，摘自 Foellinger，Nichtlineare Regelungen II，第 280 页。"
  ...
  parameter Real a1 = 0.2674 "过程参数（请参阅帮助中的参考资料）";
  parameter Real a21 = 1.815 "过程参数（请参阅帮助中的参考资料）";
  parameter Real a22 = 0.4682 "过程参数（请参阅帮助中的参考资料）";
  parameter Real b = 1.5476 "过程参数（请参阅帮助中的参考资料）";
  parameter Real k0 = 1.05e14 "过程参数（请参阅帮助中的参考资料）";
