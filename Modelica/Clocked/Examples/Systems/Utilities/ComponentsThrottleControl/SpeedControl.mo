...
block SpeedControl 
  ...
  parameter Real k_p = 0.0614 "比例增益";
  parameter Real k_I = 0.0723 "积分增益";
  Modelica.Blocks.Interfaces.RealInput N_des(unit="rad/s", start=0) "期望速度, (rad/s)" annotation (Placement(transformation(extent={{-140,20},{-100,60}})));
  Modelica.Blocks.Interfaces.RealInput N(unit="rad/s", start=0) "测量速度, (rad/s)" annotation (Placement(transformation(extent={{-140,-80},{-100,-40}})));
  Modelica.Blocks.Interfaces.RealOutput Theta(start=8.9, unit="deg") 
    "节流阀角度(deg)" annotation (Placement(transformation(extent={{100,-10},{120,10}})));
protected
