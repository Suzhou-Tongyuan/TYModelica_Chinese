...
block Step "生成布尔类型的阶跃信号"
  ...
  parameter Integer startTick = 0 
    "时钟刻度 < startTick 时，输出 y = startValue";
  parameter Boolean startValue = false "startTick 之前的输出";
...
<p>
布尔输出 y 是阶跃信号。该信号以时钟刻度而不是模拟时间来定义：
</p>
...
<h4>Example</h4>
<p>
见模型 <a href=\"modelica://Modelica.Clocked.Examples.Elementary.BooleanSignals.TickBasedStep\">Modelica.Clocked.Examples.Elementary.BooleanSignals.TickBasedStep</a>.
</p>
</html>"));
end Step;