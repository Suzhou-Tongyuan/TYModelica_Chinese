...
package ComplexMath "作为输入/输出模块的数学函数库"
  extends Modelica.Icons.Package;

  annotation(Documentation(info = "<html>
<p>
这个包包含基本<strong>数学运算</strong>，如求和和乘法，以及基本的<strong>数学函数</strong>，
如<strong>sqrt</strong>和<strong>sin</strong>，作为输入/输出模块。
本库的所有模块可以与连续模块或采样数据模块连接。
</p>
</html>",
    revisions = "<html>
</html>"),
