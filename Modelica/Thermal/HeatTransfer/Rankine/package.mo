...
package Rankine "具有兰氏度输入和/或输出的组件"
  extends Modelica.Icons.VariantsPackage;

  annotation (Documentation(info="<html><p style=\"text-align: start;\">该库中的组件专为习惯使用兰氏度单位的人员提供便利，因为HeatTransfer库中的所有模型均基于开尔文单位。
</p>
...
<pre><code >import Modelica.Units.Conversions.from_degRk;
