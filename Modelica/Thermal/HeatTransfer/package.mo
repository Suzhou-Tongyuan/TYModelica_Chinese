...
package HeatTransfer "集总元件的一维传热库"
...
该库包含用于通过集中参数元件模拟<strong>一维传热</strong>的组件。
</p>
</html>",revisions="<html>
<ul>
<li><em>July 15, 2002</em>
       由Michael Tiller, <a href=\"http://www.robotic.dlr.de/Martin.Otter/\">Martin Otter</a>
       和Nikolaus Sch&uuml;rmann:<br>
       实施。
</li>
<li><em>June 13, 2005</em>
       由 <a href=\"https://www.haumer.at/\">Anton Haumer</a><br>
       改进连接器的放置(外观)。<br>
       完善了所有示例；删除了Examples.FrequencyInverter，引入了Examples.Motor。<br>
       在固定/规定热流中引入与温度相关的修正(1 + alpha*(T - T_ref))。<br>
</li>
  <li> v1.1.1 2007/11/13 Anton Haumer<br>
       组件移至子库</li>
  <li> v1.2.0 2009/08/26 Anton Haumer<br>
       添加了组件ThermalCollector</li>
