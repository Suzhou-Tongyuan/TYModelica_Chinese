...
<li>添加文档: 2002 年 12 月</li>
    ...
    package Regions 
      ...
      function region_ph 
        "根据给定压力和比焓计算 IF97 中的当前区域（有效值为：1,2,3,4,5）"
        extends Modelica.Icons.Function;
        input SI.Pressure p "压力";
      ...
      function region_ps 
        "根据给定的压力和比熵计算 IF97 中当前区域（有效值：1、2、3、4、5）"
        extends Modelica.Icons.Function;
        input SI.Pressure p "压力";
      ...
      function region_pT 
        "根据压力和温度计算当前区域（有效值：1、2、3、5），IF97 中，区域 4 是不可能的！"
        extends Modelica.Icons.Function;
        input SI.Pressure p "压力";
        input SI.Temperature T "温度（K）";
      ...
      function region_dT 
        "根据密度和温度计算当前区域（有效值：1、2、3、4、5），IF97 中"
        extends Modelica.Icons.Function;
      ...
      function drhol_dp
        extends Modelica.Icons.Function;
        input SI.Pressure p "饱和压力";
        output SI.DerDensityByPressure dd_dp "饱和水密度对压力的导数";
      algorithm
      ...
      function drhov_dp
        extends Modelica.Icons.Function;
        input SI.Pressure p "饱和压力";
        output SI.DerDensityByPressure dd_dp "饱和蒸汽密度对压力的导数";
      algorithm
...
初始版本：2002年10月</li>
    ...
    package Isentropic 
      ...
      function hofpsdt3 
        "区域 3 中在给定好的密度和温度（d 和 T）的情况下的等熵比焓 h(p,s)"
