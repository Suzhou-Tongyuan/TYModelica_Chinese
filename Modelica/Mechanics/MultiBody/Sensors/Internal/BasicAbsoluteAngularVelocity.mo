...
model BasicAbsoluteAngularVelocity "用于测量绝对角速度的基本传感器"
...
该矢量在输出信号连接器&nbsp;<strong>w</strong>中提供。
</p>
...
如果resolveInFrame=Types.ResolveInFrameA.frame_resolve，则矢量&nbsp;w解析到连接到frame_resolve的坐标系中。
</p>
