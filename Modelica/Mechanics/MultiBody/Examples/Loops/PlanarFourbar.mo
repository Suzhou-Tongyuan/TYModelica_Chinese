...
model PlanarFourbar "具有一个运动环的平面四杆机构(使用平面闭环约束转动副)"
...
grid={2,2}),graphics = {Polygon(origin={14,1}, 
lineColor={255,0,0}, 
pattern=LinePattern.Dash, 
lineThickness=0.5, 
points={{-68,47},{68,47},{68,-47},{12,-47},{12,-1},{-68,-1},{-68,47}}), Text(origin={0,10}, 
lineColor={255,0,0}, 
extent={{0,8},{0,-8}}, 
textString="可用JointRRR组件替换", 
fontSize=14, 
textColor={255,0,0})}));
end PlanarFourbar;