...
partial model PartialElementaryTwoFlangesAndSupport2 
    "具有两个一维转动接口和一个支撑的部分模型，用于文本建模，即用于基本模型"
  ...
  Flange_a flange_a "左轴的一维转动接口" annotation (Placement(
        transformation(extent={{-110,-10},{-90,10}})));
  Flange_b flange_b "右轴的一维转动接口" annotation (Placement(
        transformation(extent={{90,-10},{110,10}})));
  Support support(phi=phi_support, tau=-flange_a.tau - flange_b.tau) if 
    useSupport "组件的支撑/轴承座" 
...
<p>
这是一个具有两个一维转动接口和一个支撑/轴承座的一维旋转组件。
