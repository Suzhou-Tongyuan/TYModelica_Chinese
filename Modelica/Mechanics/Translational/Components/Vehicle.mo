...
model Vehicle "简单的车辆模型"
  ...
  parameter Boolean useCrInput = false "启用Cr信号输入" 
...
public
  ...
  RollingResistance fRoll(
    ...
    extent = {{-10, -10}, {10, 10}}, 
    origin = {60, 0})));
  Sources.Force fGrav "抗倾角" 
    annotation(Placement(transformation(
    extent = {{-10, -10}, {10, 10}}, 
    origin = {60, 30})));
  Modelica.Mechanics.Translational.Interfaces.Flange_b flangeT "一维平动接口" 
    annotation(Placement(transformation(extent = {{90, 10}, {110, -10}})));
  Modelica.Mechanics.Rotational.Interfaces.Flange_a flangeR "一维转动接口" 
