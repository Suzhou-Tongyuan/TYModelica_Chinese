...
model SpringDamper "弹簧/阻尼模型的输入/输出块"
...
equation
  ...
  connect(positionToForce1.p, s1) annotation (Line(points={{-23,8},{-40, 
          8},{-40,80},{-120,80}}, color={0,0,127}));
  connect(positionToForce1.pder, v1) annotation (Line(points={{-23,5},{-60, 
          5},{-60,50},{-120,50}},  color={0,0,127}));
  connect(positionToForce2.p, s2) annotation (Line(points={{23,8},{40,8}, 
          {40,80},{120,80}}, color={0,0,127}));
  connect(positionToForce2.pder, v2) annotation (Line(points={{23,5},{60,5}, 
...
<p>
一个线性的一维平动弹簧和阻尼器，与纯信号接口并联，可用于FMU(<a href=\"https://fmi-standard.org\">Functional Mock-up Unit</a>) 交换。
</p>
</html>"));
end SpringDamper;