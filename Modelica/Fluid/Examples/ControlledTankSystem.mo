...
package ControlledTankSystem 
  ...
  model ControlledTanks 
    ...
    Modelica.Fluid.Valves.ValveDiscrete valve1(redeclare package Medium = Medium, 
      m_flow_nominal = 40, 
      dp_nominal = 100000) 
...
阀门 1 打开，水箱 1 加满油。</li>
<li>
当水箱 1 达到其填充液位极限时，阀门 1 关闭。</li>
<li>
等待一段时间后，阀门 2 打开，流体从水箱 1 流入水箱 2。</li>
<li>
当水箱 1 达到最低液位时，阀门 2 关闭。</li>
<li>
等待一段时间后，阀门 3 打开，流体从水箱 2 流出</li>
<li>
当水箱 2 达到最低液位时，阀门 3 关闭</li>
</ol><p>
上述过程可受三个按钮的影响：
</p>
<ul><li>
<strong>start</strong> 按钮选项启动上述过程。当 \"停止 \"或 \"关闭 \"操作后按下该按钮时，流程操作继续进行。</li>
<li>
<strong>stop</strong> 按钮关闭所有阀门，停止上述过程。然后，控制器等待进一步的输入（\"启动 \"或 \"关闭 \"操作）。</li>
<li>
<strong>shut</strong> 按钮用于关闭工艺，通过打开 2 号阀和 3 号阀一次性清空两个水箱。
关闭后，流程将回到起始配置，此时所有 3 个阀门均处于关闭状态。点击 \"start \"按钮，流程重新启动。</li>
</ul><p>
The demo-run uses the following button presses:演示运行使用以下按钮：
</p>
<ul><li>
20 秒时按下 <strong>start </strong>按钮。</li>
<li>
220 s时按下 <strong>stop </strong>按钮</li>
<li>
280 s时按下 <strong>start </strong>按钮</li>
<li>
650 s时按下 <strong>stop</strong> 按钮</li>
<li>
700 s时按下 <strong>shut</strong> 按钮</li>
<li>
仿真 900 秒</li>
</ul><p>
本示例基于
...
<p>
<strong>Code Generation From JGrafchart to Modelica</strong>.<br>Master thesis, 
supervisor: Karl-Erik Årzén,<br>Department of Automatic Control, Lund Institute of Technology,
<br>Lund, Sweden, March 30, 2004
</p>
...
<img src=\"modelica://Modelica/Resources/Images/Fluid/Examples/ControlledTankSystem/ControlledTanks.png\" border=\"1\"
  ...
  package Utilities
    ...
    model TankController "水箱系统控制器"
      ...
      parameter SI.Height maxLevel "1 号水箱的充满水位";
      parameter SI.Height minLevel "1 号和 2 号水箱的最低水位";
      parameter SI.Time waitTime "操作之间的等待时间";
