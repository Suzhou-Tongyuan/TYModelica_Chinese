...
<p>2016-04-12 Stefan Wischhusen: 将 Re_Dh 和 Re_Lp 限制在非常小的值（Modelica.Constant.eps）。</p>
      ...
      record kc_flatTube_IN_con 
        ...
        Real alpha = 0 "侧鳍间距 (s) / 自由流高度 (h)" annotation(
          Dialog(group = "换热", enable = geometry == 2));
...
<li>
<strong>弯曲轴线上的弯头长度 / 直径 ≥ 10</strong> <em>[Idelchik 2006, p. 357, diag. 6-1]</em></li>
<li>
    ...
    package TwoPhase 
      ...
      extends Modelica.Icons.FunctionsPackage;
          ...
          protected
            ...
            Real mdot_A = abs(m_flow) / Across "质量通量";
